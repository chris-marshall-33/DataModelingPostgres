...
# CREATE TABLES
# MAY NEED TO CHECK DATA TYPES IF ANY ERRORS OCCUR
songplay_table_create = ("""CREATE TABLE IF NOT EXISTS songplays (songplay_id varchar, start_time time, user_id varchar, level varchar, song_id varchar, artist_id varchar,
